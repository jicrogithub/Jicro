...
const AddService = ({ navigation }) => {
    ...
    return (
        <>
            <UniversalHeader />
            <ScrollView className="h-full w-full bg-white p-2  " >
                {
                    images.length === 0 && <TouchableOpacity activeOpacity={0.8} onPress={() => {
                        ...
                        <Text className="text-center font-bold text-white text-3xl" >Upload Service Picture</Text>
                        <Text className="text-center font-light text-white text-md" >Helps to Rank your Service</Text>
                    </TouchableOpacity>
                }
                {
                    images.length > 0 && <View className="mb-2" >
                ...
                />
                <View className="px-1" >
                    <Text className="font-black text-gray-500 text-lg" >Details for Service</Text>
